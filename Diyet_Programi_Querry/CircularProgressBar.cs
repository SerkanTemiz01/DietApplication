...
public class CircularProgressBar : Control
{
    ...
    private int _LineWitdh = 3;
    private float _BarWidth = 14f;

    private Color _ProgressColor1 = Color.Blue;
    ...
    public CircularProgressBar()
    {
        ...
        this.LineWidth = 1;
        this.LineColor = Color.SteelBlue;
            ...
            using (Graphics graphics = Graphics.FromImage(bitmap))
            {
                ...
                switch (this.TextMode)
                {
                    ...
                    case _TextMode.Percentage:
                        this.Text =" "+ (alinanKalori.ToString() + "\n" + (" %" + Convert.ToString(Convert.ToInt32((100 / _Maximum) * _Value))));
                        break;
