...
namespace Diyet_Programi_Querry
{
    public partial class SuEkle : Form
    {
        ...
        {
            if (flowLayoutPanel1.Controls.Count+nmrSu.Value<=16)
            {
                for (int i = 0; i < nmrSu.Value; i++)
                {
                    pictureBox = new PictureBox();
                    pictureBox.Size = new Size(100, 73);
                    pictureBox.Image = Image.FromFile("C:\\Users\\fatih\\source\\repos\\SerkanTe\\Diyet_Programi_Ortak\\Diyet_Programi_Querry\\Resources\\Bardak.png");
        ...
        private void btnÇıkart_Click(object sender, EventArgs e)
        {
            ...
            else if (nmrSu.Value >= flowLayoutPanel1.Controls.Count)
            {
